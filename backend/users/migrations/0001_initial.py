    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_categories', models.JSONField(blank=True, default=list, verbose_name='Categorías favoritas')),
                ('rfm_score', models.IntegerField(default=0, verbose_name='RFM Score')),
                ('customer_segment', models.CharField(blank=True, max_length=50, verbose_name='Segmento')),
