        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    ...
                    <Link href="/admin/marcas/nuevo" className="inline-flex items-center space-x-2 bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition shadow-lg">
                ...
                <div className="bg-white rounded-lg shadow-sm p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Buscar marcas..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" />
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <Link href="/admin/marcas/nuevo" className="inline-flex items-center space-x-2 bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition">
                                <Plus className="h-5 w-5" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
                            {brands.map((brand) => (
                                <div key={brand.id} className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:border-purple-500 hover:shadow-lg transition group">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex items-center space-x-2 pt-3 border-t border-gray-200">
                                            <Link href={`/admin/marcas/${brand.slug}`} className="flex-1 inline-flex items-center justify-center space-x-1 px-3 py-2 text-purple-600 hover:bg-purple-50 rounded-lg transition text-sm font-medium">
                                                <Edit className="h-4 w-4" />
                                                <span>Editar</span>
                                            </Link>
                                            <button onClick={() => handleDelete(brand)} className="flex-1 inline-flex items-center justify-center space-x-1 px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg transition text-sm font-medium">
                    ...
                    <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-start space-x-4 mb-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-600 text-sm">¿Estás seguro de eliminar "<strong>{brandToDelete?.name}</strong>"? Esta acción no se puede deshacer.</p>
                            </div>
                        </div>
                        <div className="flex space-x-3 mt-6">
                            <button onClick={() => setShowDeleteModal(false)} className="flex-1 px-4 py-2.5 border-2 border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 transition-all">Cancelar</button>
                            <button onClick={confirmDelete} className="flex-1 px-4 py-2.5 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 shadow-lg transition-all">Eliminar</button>
                        </div>
                    </div>
                </div>
            )}
